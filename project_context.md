...
| P4.6 | **Hand-label a 60-item gold set** — stratified, includes ambiguous-name negatives | R13 | 1.5 h | **CANDIDATES BUILT** — `npm run gold:build` → 60 unlabelled items from live data; **awaiting labels** |
